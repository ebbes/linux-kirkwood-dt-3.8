# Linux 3.8 for Marvell Kirkwood devices, using device tree
...
build() {
  ...
  patch -Np1 -i "${srcdir}/sata-disk-trigger.patch"
  # set orange led to sata-disk trigger by default (I prefer it that way)
  patch -Np1 -i "${srcdir}/goflexnet-sata-trigger-on-orange-led.patch"
